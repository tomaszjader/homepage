...
const Projects = () => {
    ...
    return (
        <div id='projects' className='Projects'>
            ...
            <p className='ProjectParagraf'>I started my frontend developer path in 2020. Since then, I’ve built multiple projects. Here’s the list of some of the things I’ve done so far.</p>
